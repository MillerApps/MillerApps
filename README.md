...
- [LeoKlaus/Paperparrot](https://github.com/LeoKlaus/Paperparrot) - A native Swift app to manage all your documents. Fully compatible with Paperless-ngx (2 days ago)
- [chithi-dev/chithi](https://github.com/chithi-dev/chithi) - The next generation encrypted file sharing project (3 days ago)
- [Termix-SSH/Mobile](https://github.com/Termix-SSH/Mobile) - Mobile version of the self-hosted server managment platform Termix. (3 days ago)
